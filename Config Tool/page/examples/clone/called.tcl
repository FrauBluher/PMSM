...
proc vTclWindow.top34 {base} {
    ...
    button $top.but34 \
        ...
        -command lambda:create_clone(rt) -disabledforeground {#b8a786} \
    ...
    button $top.but35 \
        -activebackground {#f4bcb2} -activeforeground black -background wheat \
        -command close -disabledforeground {#b8a786} -font font10 \
    ...
    label $top.lab36 \
        ...
        -foreground {#000000} -highlightbackground wheat \
        -highlightcolor black -text Label -textvariable instance 
