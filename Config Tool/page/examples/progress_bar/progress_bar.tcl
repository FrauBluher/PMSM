...
proc vTclWindow.top32 {base} {
    ...
    ttk::style configure TProgressbar -background wheat
    ttk::style configure TProgressbar -foreground #000000
    ttk::style configure TProgressbar -font font10
